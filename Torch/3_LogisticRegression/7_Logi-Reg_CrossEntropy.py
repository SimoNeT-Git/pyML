...
# In this lab, you will see what happens when you use the Cross-Entropy or total loss function using random
# initialization for a parameter value.
#  - Make Some Data
...
# Replace the random initialized variable values. Theses random initialized variable values did convergence for the
# RMS Loss but will converge for the Cross-Entropy Loss.
...
label = yhat > 0.5
print("The accuracy is: ", (torch.mean((label == data_set.y.type(torch.ByteTensor)).type(torch.float))*100).tolist(), "%")
